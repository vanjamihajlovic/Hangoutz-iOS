...
class Validation {
    ...
    func isValidPassword(_ password: String) -> Bool {
        let passPredicate = NSPredicate(format: "SELF MATCHES %@", ValidationConstants.passRegex)
    ...
    func isNameValid(_ name: String) -> Bool {
        return name.count >= ValidationConstants.minNameLength && name.count <= ValidationConstants.maxNameLength
    }
}
